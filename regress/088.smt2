 ...
 (($x3432
   (forall
    ((V3_0 (_ BitVec 32)) (V2_0 (_ BitVec 32)) 
     ...
     (S1_V1_!2447 (_ BitVec 32)) (S1_V1_!2464 (_ BitVec 32)) 
     (S1_V1_!2474 (_ BitVec 32)) (S2_V5_!2456 (_ BitVec 32)) 
     (S2_V5_!2461 (_ BitVec 32)) (S2_V5_!2472 (_ BitVec 32)) 
     (S2_V5_!2482 (_ BitVec 32)) (S1_V3_!2448 (_ BitVec 32)) 
     (S1_V3_!2465 (_ BitVec 32)) (S1_V3_!2475 (_ BitVec 32)) 
     (S1_V2_!2449 (_ BitVec 32)) (S1_V2_!2466 (_ BitVec 32)) 
     (S1_V2_!2476 (_ BitVec 32)) (E1_!2446 (_ BitVec 32)) 
     (E1_!2452 (_ BitVec 32)) (E1_!2463 (_ BitVec 32)) 
     (S2_V4_!2457 (_ BitVec 32)) (S2_V4_!2462 (_ BitVec 32)) 
     (S2_V4_!2473 (_ BitVec 32)) (S2_V4_!2483 (_ BitVec 32)) 
     (S1_V5_!2450 (_ BitVec 32)) (S1_V5_!2467 (_ BitVec 32)) 
     (S1_V5_!2477 (_ BitVec 32)) (S2_V1_!2453 (_ BitVec 32)) 
     (S2_V1_!2458 (_ BitVec 32)) (S2_V1_!2469 (_ BitVec 32)) 
     (S2_V1_!2479 (_ BitVec 32)) (S1_V4_!2451 (_ BitVec 32)) 
     (S1_V4_!2468 (_ BitVec 32)) (S1_V4_!2478 (_ BitVec 32)) 
     (S2_V2_!2455 (_ BitVec 32)) (S2_V2_!2460 (_ BitVec 32)) 
     (S2_V2_!2471 (_ BitVec 32)) (S2_V2_!2481 (_ BitVec 32)) 
     (S2_V3_!2454 (_ BitVec 32)) (S2_V3_!2459 (_ BitVec 32)) 
     (S2_V3_!2470 (_ BitVec 32)) (S2_V3_!2480 (_ BitVec 32)))
    (let
    (($x3002
    ...
    (let ((?x3112 (bvadd (_ bv1 32) ?x2728)))
    ...
    (let ((?x2757 (bvadd (_ bv1 32) ?x3089)))
    (let ((?x2638 (ite MW_S2_V1 S2_V1_!2458 ?x2757)))
    (let (($x3407 (= ?x2638 ?x3336)))
    (let
    (($x2689
      (and (not (bvsle V2_0 E1_!2446))
      (bvsge (ite MW_S1_V1 S1_V1_!2447 E1_!2446) (bvadd (bvneg (_ bv1 32)) ?x2857))
      (not (bvsle ?x2857 E1_!2452))
      (not (bvsle (ite MW_S2_V2 S2_V2_!2455 ?x2857) ?x2757))
      (bvsge ?x2638 (bvadd (bvneg (_ bv1 32)) ?x2553)) 
      (not (bvsle V2_0 E1_!2463)) 
      (not (bvsle ?x3388 ?x3112)) 
      (bvsge ?x3336 (bvadd (bvneg (_ bv1 32)) ?x2704)))))
    ...
    (let
    (($x3054
      (and (or (not R_S1_V1) (= ?x2728 (bvadd (bvneg (_ bv1 32)) E1_!2446))) $x3512 $x2444
      $x2631 $x3378)))
    (let (($x2831 (not $x3054)))
    ...
    (($x2679
      (or
      (not
      (and (or $x398 (= ?x3089 (bvadd (bvneg (_ bv1 32)) ?x2839))) $x2468 $x2617 $x2691
      $x3891)) $x3507)))
    (let (($x3342 (= S1_V5_!2477 S1_V5_!2467)))
    (let
    (($x2800
      (and (or (not R_S1_V1) (= ?x2728 (bvadd (bvneg (_ bv1 32)) E1_!2463))) $x3512 $x2444
      $x2631 $x3378)))
    ...
    (($x3396
      (or
      (not
      (and (or $x398 (= ?x3089 (bvadd (bvneg (_ bv1 32)) ?x3143))) $x2472 $x2580 $x3178
      $x3166)) $x2892)))
    ...
    (($x2819
      (or
      (not
      (and (or $x398 (= ?x3089 (bvadd (bvneg (_ bv1 32)) E1_!2452))) $x2899 $x3375 $x2451
      $x3393)) $x2663)))
...
(assert
 ...
 (let (($x401 (not R_S2_V3)))
 (let (($x398 (not R_S2_V1)))
 (not (and $x398 $x401 $x2387 $x2390 DISJ_W_S2_R_S1)))))))
(assert
 (let (($x2387 (not W_S2_V2)))
 (let (($x407 (not R_S2_V4)))
 (let (($x405 (not R_S2_V5)))
 (let (($x398 (not R_S2_V1)))
 (not (and $x398 $x405 $x407 $x2387 DISJ_W_S2_R_S1)))))))
(assert
 (let (($x2390 (not W_S2_V5)))
 (let (($x2387 (not W_S2_V2)))
 (let (($x407 (not R_S2_V4)))
 (let (($x398 (not R_S2_V1)))
 (not (and $x398 $x407 $x2387 $x2390 DISJ_W_S2_R_S1)))))))
(assert
 (let (($x2387 (not W_S2_V2)))
 (let (($x407 (not R_S2_V4)))
 (let (($x401 (not R_S2_V3)))
 (let (($x398 (not R_S2_V1)))
 (not (and $x398 $x401 $x407 $x2387 DISJ_W_S2_R_S1)))))))
(assert
 (let (($x2387 (not W_S2_V2)))
 (let (($x405 (not R_S2_V5)))
 (let (($x401 (not R_S2_V3)))
 (let (($x398 (not R_S2_V1)))
 (not (and $x398 $x401 $x405 $x2387 DISJ_W_S2_R_S1)))))))
...
(assert
 ...
 (let (($x2387 (not W_S2_V2)))
 (let (($x398 (not R_S2_V1)))
 (not (and $x398 $x2387 $x2390 $x2398 DISJ_W_S2_R_S1)))))))
...
(assert
 ...
 (let (($x405 (not R_S2_V5)))
 (let (($x398 (not R_S2_V1)))
 (not (and $x398 $x405 $x2387 $x2398 DISJ_W_S2_R_S1)))))))
(assert
 (let (($x2398 (not W_S2_V3)))
 (let (($x2353 (not W_S1_V5)))
 (let (($x407 (not R_S2_V4)))
 (let (($x6013 (and $x407 $x2353 $x2398 DISJ_W_S2_R_S1))) (not $x6013))))))
(check-sat)
(exit)
