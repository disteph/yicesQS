...
(declare-fun x () Real)
(assert
 (let ((?x60 (+ (* (* (/ 18.0 25.0) x!) y!) (+ (* (* 1.0 y!) y!) (* (- (/ 3.0 100.0)) x!)))))
 (let (($x64 (and (<= (- (/ 1.0 5.0)) x!) (>= (/ 1.0 10.0) x!) (<= (- (/ 1.0 10.0)) y!) (>= (/ 1.0 5.0) y!))))
 (let (($x65 (and $x64 (>= (/ 1.0 100.0) (+ (* (- (/ 11.0 100.0)) y!) (+ (* (* (/ 33.0 100.0) x!) x!) ?x60))) )))
 (let ((?x75 (+ x (* (/ 1.0 100.0) (+ (- (* (- 2.0) x) (* 3.0 y)) (* x x))))))
 (let ((?x37 (+ (* (* (/ 18.0 25.0) x) y) (+ (* (* 1.0 y) y) (* (- (/ 3.0 100.0)) x)))))
 (let (($x13 (>= (/ 1.0 10.0) x)))
 (let (($x44 (and (and (<= (- (/ 1.0 5.0)) x) $x13 (<= (- (/ 1.0 10.0)) y) (>= (/ 1.0 5.0) y)) (>= (/ 1.0 100.0) (+ (* (- (/ 11.0 100.0)) y) (+ (* (* (/ 33.0 100.0) x) x) ?x37))) )))
