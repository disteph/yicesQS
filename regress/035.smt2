 ...
 (($x3462
   (forall
    ((V3_0 (_ BitVec 32)) (V2_0 (_ BitVec 32)) 
     ...
     (S1_V1_!2447 (_ BitVec 32)) (S1_V1_!2457 (_ BitVec 32)) 
     (S1_V1_!2468 (_ BitVec 32)) (S2_V5_!2455 (_ BitVec 32)) 
     (S2_V5_!2465 (_ BitVec 32)) (S2_V5_!2477 (_ BitVec 32)) 
     (S2_V5_!2482 (_ BitVec 32)) (S1_V3_!2448 (_ BitVec 32)) 
     (S1_V3_!2458 (_ BitVec 32)) (S1_V3_!2469 (_ BitVec 32)) 
     (S1_V2_!2449 (_ BitVec 32)) (S1_V2_!2459 (_ BitVec 32)) 
     (S1_V2_!2470 (_ BitVec 32)) (E1_!2446 (_ BitVec 32)) 
     (E1_!2467 (_ BitVec 32)) (E1_!2473 (_ BitVec 32)) 
     (S2_V4_!2456 (_ BitVec 32)) (S2_V4_!2466 (_ BitVec 32)) 
     (S2_V4_!2478 (_ BitVec 32)) (S2_V4_!2483 (_ BitVec 32)) 
     (S1_V5_!2450 (_ BitVec 32)) (S1_V5_!2460 (_ BitVec 32)) 
     (S1_V5_!2471 (_ BitVec 32)) (S2_V1_!2452 (_ BitVec 32)) 
     (S2_V1_!2462 (_ BitVec 32)) (S2_V1_!2474 (_ BitVec 32)) 
     (S2_V1_!2479 (_ BitVec 32)) (S1_V4_!2451 (_ BitVec 32)) 
     (S1_V4_!2461 (_ BitVec 32)) (S1_V4_!2472 (_ BitVec 32)) 
     (S2_V2_!2454 (_ BitVec 32)) (S2_V2_!2464 (_ BitVec 32)) 
     (S2_V2_!2476 (_ BitVec 32)) (S2_V2_!2481 (_ BitVec 32)) 
     (S2_V3_!2453 (_ BitVec 32)) (S2_V3_!2463 (_ BitVec 32)) 
     (S2_V3_!2475 (_ BitVec 32)) (S2_V3_!2480 (_ BitVec 32)))
    (let
    (($x2590
      (=
    ...
    (let ((?x3074 (bvadd (_ bv1 32) ?x2975)))
    ...
    (let ((?x2861 (bvadd (_ bv1 32) ?x2771)))
    ...
    (($x2492
      ...
      (not (bvsle ?x2846 ?x2861)) 
      (bvsge ?x3262 (bvadd (bvneg (_ bv1 32)) ?x2463)) 
      (not (bvsle V2_0 E1_!2467))
      (bvsge (ite MW_S1_V1 S1_V1_!2468 E1_!2467) (bvadd (bvneg (_ bv1 32)) ?x2455))
      (not (bvsle ?x2455 E1_!2473))
      (not (bvsle (ite MW_S2_V2 S2_V2_!2476 ?x2455) ?x3074))
      (bvsge ?x3454 (bvadd (bvneg (_ bv1 32)) ?x3368)))))
    ...
    (($x4079
      (or
      (not
      (and (or $x215 (= ?x2975 (bvadd (bvneg (_ bv1 32)) E1_!2473))) $x3434 $x3978 $x3325
      $x3743)) $x3632)))
    ...
    (($x3162
      (or
      (not
      (and (or $x215 (= ?x2975 (bvadd (bvneg (_ bv1 32)) ?x3185))) $x3139 $x3224 $x3990
      $x3946)) $x4012)))
    ...
    (($x3164
      (or
      (not
      (and (or $x215 (= ?x2975 (bvadd (bvneg (_ bv1 32)) ?x3583))) $x3896 $x3758 $x3634
      $x3928)) $x3592)))
    ...
    (let
    (($x4166
      (and (or (not R_S1_V1) (= ?x2771 (bvadd (bvneg (_ bv1 32)) E1_!2467))) $x3831 $x4060
      $x4106 $x2809)))
    (let (($x3863 (= S1_V2_!2459 S1_V2_!2449)))
    (let
    (($x3877
      (and (or (not R_S1_V1) (= ?x2771 (bvadd (bvneg (_ bv1 32)) E1_!2446))) $x3831 $x4060
      $x4106 $x2809)))
    (let (($x3922 (not $x3877)))
